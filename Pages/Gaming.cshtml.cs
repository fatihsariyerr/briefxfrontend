...
{
    private readonly ILogger<GamingModel> _logger;
  ...
  public GamingModel(ILogger<GamingModel> logger)
    {
        _logger = logger;
    }
  ...
  public async Task<JsonResult> OnGetLoadMoreAsync(int skip, int take = 15)
  {
    ...
    using (var connection = new NpgsqlConnection(_connectionString))
    {
      ...
      string query = "SELECT * FROM news WHERE category='gaming' ORDER BY publishdate DESC LIMIT @take OFFSET @skip";
  ...
  public async Task OnGetAsync(string search = null)
  {
    ...
    using (var connection = new NpgsqlConnection(_connectionString))
    {
      ...
      string query = "SELECT * FROM news where category='gaming' ORDER BY publishdate DESC";
