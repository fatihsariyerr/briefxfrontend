...
public class SportModel : PageModel
{
  ...
  public async Task<JsonResult> OnGetLoadMoreAsync(int skip, int take = 15)
  {
    ...
    using (var connection = new NpgsqlConnection(_connectionString))
    {
      ...
      string query = "SELECT * FROM newsinternational WHERE category='sport' ORDER BY publishdate DESC LIMIT @take OFFSET @skip";
  ...
  public async Task OnGetAsync(string search = null)
  {
    ...
    {
      connection.Open();
      string query = "SELECT * FROM newsinternational where category='sport' ORDER BY publishdate DESC";
