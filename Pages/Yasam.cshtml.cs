...
public class YasamModel : PageModel
{
  ...
  public async Task<JsonResult> OnGetLoadMoreAsync(int skip, int take = 15)
  {
    ...
    using (var connection = new NpgsqlConnection(_connectionString))
    {
      ...
      string query = "SELECT * FROM news WHERE category='yasam' ORDER BY publishdate DESC LIMIT @take OFFSET @skip";
  ...
  public async Task OnGetAsync(string search = null)
  {
    ...
    using (var connection = new NpgsqlConnection(_connectionString))
    {
      ...
      string query = "SELECT * FROM news where category='yasam' ORDER BY publishdate DESC";
